...
-- gender wise summary
select sex,count(*) as s_count from tips  group by sex order by s_count ;

-- day wise  total bill summary
select day,sum(total_bill) from tips group by day  ;

-- gender  wise total bill summary
select sex,sum(total_bill) from tips group by sex ;

-- day wise tip sumamry
select day,sum(tip) from tips group by day;
...
select total_bill,max(total_bill) from tips where total_bill=(select max(total_bill) from tips